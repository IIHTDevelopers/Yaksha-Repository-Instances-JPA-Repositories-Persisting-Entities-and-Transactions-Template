...
public class MasterData {
	...
	// Create a sample Product instance with stock
	public static Product getProduct() {
		Product product = new Product("Product A", "A sample product", 100.0, 50); // Setting stock to 50
	...
	public static Order getOrder() {
		Order order = new Order(1L, 2); // Order for 2 units of product with ID 1
		order.setId(1L); // Setting the ID for the order
		return order;
	}
	...
	public static List<Order> getOrderList() {
		...
		orderList.add(getOrder()); // Adding a sample order
		return orderList;
	}
